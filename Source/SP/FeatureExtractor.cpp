...
namespace FeatureExtractor{
    ...
    void DurbinsAlgorithm(long double* lpc, long double* r, int p){
        // lpc has p values
    ...
    void LPCtoCepstral(long double* cepstral, long double* lpc, int p){
        // lpc is of size p
    ...
    void LPCcoefficients(long double* lpc, int p, long double* main_frame, int frame_size){

...
int PreProcess::preprocess(int* input, std::string input_filename, std::string output_filename){
...
int PreProcess::LoadInputInteger(int* input, std::string filename){
    std::ifstream file;
    file.open(filename);
...
int PreProcess::LoadInputReal(long double* input, std::string filename){
    std::ifstream file;
    file.open(filename);
